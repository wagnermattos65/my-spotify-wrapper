...
var MySpotifyWrapper = function () {
  function MySpotifyWrapper(options) {
    _classCallCheck(this, MySpotifyWrapper);
  ...
  return MySpotifyWrapper;
}();

exports.default = MySpotifyWrapper;